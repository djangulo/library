module.exports = {
  ...
  paginateBy: parseInt(process.env.PAGINATE_BY, 10) || 5,
  ...
  datadirs: {
    ...
    corpora: process.env.CORPORA_DIR || './src/db/nltk_data/corpora'
  },
  clientAddr: process.env.CLIENT_ADDR || 'http://localhost:3000',
  rootUrl: process.env.ROOTURL || 'http://localhost:9000',
  s3BucketRoot: 'https://library-api-seed-data.s3.amazonaws.com/'
};
