...
func TestBookQueriesWithoutCache(t *testing.T) {
	...
	testBooks, _ := server.Store.Books(2, 0)
	testAuthors, _ := server.Store.Authors(2, 0)
...
func TestBookQueriesWithCache(t *testing.T) {

	cache, _ := books.NewRedisCache(cnf.Cache["test"])
